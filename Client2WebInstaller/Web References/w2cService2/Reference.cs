...
namespace Client2WebInstaller.w2cService2 {
    using System;
    ...
    public partial class w2cService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public w2cService() {
            this.Url = global::Client2WebInstaller.Properties.Settings.Default.Client2WebInstaller_w2cService2_w2cService;
        ...
        /// <remarks/>
        public void HelloAsync(string word) {
            this.HelloAsync(word, null);
        }
        
        /// <remarks/>
        public void HelloAsync(string word, object userState) {
            ...
            this.InvokeAsync("Hello", new object[] {
                        word}, this.HelloOperationCompleted, userState);
        }
